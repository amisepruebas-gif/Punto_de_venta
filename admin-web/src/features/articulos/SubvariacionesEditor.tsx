      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-muted-foreground">
            Variantes con stock individual (color, modelo, etc.). El precio
            base se comparte con el padre; cada variante puede tener su propio
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Label
                      htmlFor={`sv-precio-descuento-${idx}`}
                      className="w-24 shrink-0 text-xs"
                    >
                      Precio desc.
                    </Label>
                    <Input
                      id={`sv-precio-descuento-${idx}`}
                      type="number"
                      inputMode="decimal"
                      min="0"
                      value={sv.precioDescuento ?? ""}
                      onChange={(e) =>
                        patch(idx, { precioDescuento: e.target.value })
                      }
                  ...
                  <ImageUpload
                    ...
                    onRemove={() => {
                      // Patrón espejo del FIX D3 para la imagen principal:
                      // imagenUrl: "" explícito = "user quitó la imagen".
                      // El service lo respeta y borra el archivo en Storage.
                      // También limpiamos el File pendiente (si lo había).
                      setFile(idx, null, false);
                      patch(idx, { imagenUrl: "" });
                    }}
                  />
                </div>
