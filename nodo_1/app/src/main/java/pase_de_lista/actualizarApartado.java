...
public class actualizarApartado {
    static public void actualizaApartado_init(String id_subir, Context context) throws JSONException {
        ...
        if (jsonDatos.has(context.getString(R.string.apartados_ac))){
            jsonDatos.getJSONObject(context.getString(R.string.apartados_ac)).put(id_subir, array_id_dispositivo);
            jsonDatos.getJSONObject(context.getString(R.string.apartados_ac)).put("huella", huella);
        }else {
            JSONObject obj = new JSONObject();
            obj.put(id_subir, array_id_dispositivo);
            obj.put("huella", huella);
            jsonDatos.put(context.getString(R.string.apartados_ac), obj);
        }
        fire.documenRef("datos/" + context.getString(R.string.apartados_ac)).
                set(new Gson().fromJson(
                        jsonDatos.getJSONObject(context.getString(R.string.apartados_ac)).toString(), HashMap.class)).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
