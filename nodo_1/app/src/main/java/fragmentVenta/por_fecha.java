...
public class por_fecha extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.vista_venta_v2, container, false);
        context = view.getContext();
        sliding = (SlidingUpPanelLayout) view.findViewById(R.id.panelStateVentaPorFecha);
        recyclerHistorial_dos = (RecyclerView)view.findViewById(R.id.recyclerHistorial_dos);
        recyclerHistorial_dos.setHasFixedSize(true);
        recyclerHistorial_dos.setLayoutManager(new LinearLayoutManager(view.getContext()));
        ...
        ((Button)view.findViewById(R.id.button38)).setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            if(object.length() > 0){
                ...
                adapVista_surtir_en_venta =
                        new adapVista_surtir_en_venta(
                                ...
                                "vendido",
                                adapterHistorialDos);
                RecyclerView recycler_surtir_en_venta = (RecyclerView) view.findViewById(R.id.recycler_surtir_en_venta);
                generales.recyclerVertical(recycler_surtir_en_venta, context);
